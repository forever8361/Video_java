...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int titleSubHeight;
    private int titleBackground;
    private int titleSubBackground;
    private int titleSubTextColor;
    private int titleTextColor;
    private int titleSubTextSize;
    ...
    private List<String> bannerSubTitles;
    ...
    public RelativeLayout rlCustomView;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        titleSubHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_title_sub_height, BannerConfig.TITLE_HEIGHT);
        titleSubBackground = typedArray.getColor(R.styleable.Banner_title_sub_background, BannerConfig.TITLE_BACKGROUND);
        titleSubTextColor = typedArray.getColor(R.styleable.Banner_title_sub_textcolor, BannerConfig.TITLE_TEXT_COLOR);
        titleSubTextSize = typedArray.getDimensionPixelSize(R.styleable.Banner_title_sub_textsize, BannerConfig.TITLE_TEXT_SIZE);
        typedArray.recycle();
    }
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        rlCustomView = (RelativeLayout) view.findViewById(R.id.rl_custom);
        ...
        bannerTitle = (TextView) view.findViewById(R.id.tv_banner);
        numIndicator = (TextView) view.findViewById(R.id.numIndicator);
        numIndicatorInside = (TextView) view.findViewById(R.id.numIndicatorInside);

        tvBannerSubTitle = (TextView) view.findViewById(R.id.tv_banner_subtitle);
    ...
    public Banner setBannerSubTitles(List<String> titles) {
        this.bannerSubTitles = titles;
        return this;
    }
    ...
    public void updateBannerStyle(int bannerStyle) {
        ...
        tvBannerSubTitle.setVisibility(View.GONE);
...
//        }
        ...
        if (titleSubBackground != -1) {
            tvBannerSubTitle.setBackgroundColor(titleSubBackground);
        }
        if (titleSubHeight != -1) {
            tvBannerSubTitle.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, titleHeight));
        }
        if (titleSubTextColor != -1) {
            tvBannerSubTitle.setTextColor(titleSubTextColor);
        }
        if (titleSubTextSize != -1) {
            tvBannerSubTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, titleSubTextSize);
        }
        if (bannerSubTitles != null && bannerSubTitles.size() > 0) {
            tvBannerSubTitle.setText(bannerSubTitles.get(0));
            tvBannerSubTitle.setVisibility(View.VISIBLE);
        }
    ...
    public void onPageSelected(int position) {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.NUM_INDICATOR_TITLE:
                ...
                tvBannerSubTitle.setText(bannerSubTitles.get(position - 1));
                break;
            case BannerConfig.CIRCLE_INDICATOR_TITLE:
                bannerTitle.setText(titles.get(position - 1));
                tvBannerSubTitle.setText(bannerSubTitles.get(position - 1));
