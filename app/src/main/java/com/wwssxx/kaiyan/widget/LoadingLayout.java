...
import com.wwssxx.kaiyan.utils.ColorUtil;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        loadingPage.setBackgroundColor(ColorUtil.getColor(mContext, backgroundColor));
        errorPage.setBackgroundColor(ColorUtil.getColor(mContext, backgroundColor));
        emptyPage.setBackgroundColor(ColorUtil.getColor(mContext, backgroundColor));
        networkPage.setBackgroundColor(ColorUtil.getColor(mContext, backgroundColor));

        errorText = ColorUtil.findViewById(errorPage, R.id.error_text);
        emptyText = ColorUtil.findViewById(emptyPage, R.id.empty_text);
        networkText = ColorUtil.findViewById(networkPage, R.id.no_network_text);

        errorImg = ColorUtil.findViewById(errorPage, R.id.error_img);
        emptyImg = ColorUtil.findViewById(emptyPage, R.id.empty_img);
        networkImg = ColorUtil.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = ColorUtil.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = ColorUtil.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(ColorUtil.getColor(mContext, tipTextColor));
        emptyText.setTextColor(ColorUtil.getColor(mContext, tipTextColor));
        networkText.setTextColor(ColorUtil.getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(ColorUtil.getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(ColorUtil.getColor(mContext, buttonTextColor));

        if (buttonHeight != -1) {

            errorReloadBtn.setHeight(ColorUtil.dp2px(mContext, buttonHeight));
            networkReloadBtn.setHeight(ColorUtil.dp2px(mContext, buttonHeight));
        }
        if (buttonWidth != -1) {

            errorReloadBtn.setWidth(ColorUtil.dp2px(mContext, buttonWidth));
            networkReloadBtn.setWidth(ColorUtil.dp2px(mContext, buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(ColorUtil.getColor(mContext, id));
        networkReloadBtn.setTextSize(ColorUtil.getColor(mContext, id));
        return this;
    }
